...
{
    public static EMVEnableFeatures? UIOptions { get; set; }
    ...
    {
        var c = this.GetOcx() as dynamic;
        if (c != null && UIOptions != null)
        {
            c.EnableFeatures = UIOptions;
        }
    }
    ...
    public int CurrentConfigurationIndex
    {
        ...
        {
            VerifyOcx();
            return Ocx.CurrentConfigurationIndex;
        }
    }
    ...
    public int EnableFeatures
    {
        ...
        {
            VerifyOcx();
            return Ocx.EnableFeatures;
        }
        set
        {
            VerifyOcx();
            Ocx.EnableFeatures = value;
        }
    }
        ...
        set
        {
            ...
            if (value < -1 || value > 0)
            {
                throw new InvalidOperationException(
                    $"The FullUI Property only can be set to -1 or 0,you canot set it as {value.ToString()}"
                );
            }
            Ocx.FullUI = value;
        }
    ...
    public bool IsMarkupModified
    {
        get
        {
            VerifyOcx();
            return Ocx.IsMarkupModified;
        }
    }
    ...
    public string MaterialPropertyName
    {
        ...
        {
            VerifyOcx();
            return Ocx.MaterialPropertyName;
        }
    }
    ...
    public bool PaperColorOverride
    {
        ...
        {
            VerifyOcx();
            return Ocx.PaperColorOverride;
        }
        set
        {
            VerifyOcx();
            Ocx.PaperColorOverride = value;
        }
    }
    ...
    {
        VerifyOcx();
        return Ocx.SheetName(SheetIndex);
    }
    ...
    public bool StereoEnabled
    {
        ...
        {
            VerifyOcx();
            return Ocx.StereoEnabled;
        }
        set
        {
            VerifyOcx();
            Ocx.StereoEnabled = value;
        }
    }
    ...
    public float StereoSeparation
    {
        ...
        {
            VerifyOcx();
            return Ocx.StereoSeparation;
        }
        set
        {
            VerifyOcx();
            Ocx.StereoSeparation = value;
        }
    }
    ...
    public double[] ViewCamera
    {
        ...
        {
            VerifyOcx();
            return Ocx.ViewCamera;
        }
        set
        {
            VerifyOcx();
            Ocx.ViewCamera = value;
        }
    }
    ...
    public int CreateToolTip(
        string TipTitle,
        string TipText,
        bool ShowAtMousePostion,
        int XCoordinate,
        int YCoordinate
    )
    {
    ...
    private void VerifyOcx()
    {
        ...
        {
            throw new InvalidOperationException(
                $"Can not get edrawing's OCX.Check whether edrawing is installed"
            );
        }
    }
    ...
    public void SetPageSetupOptions(
